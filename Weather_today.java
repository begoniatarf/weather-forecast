    ...
    public void changeimg(String weathers){
        if(weathers.contains("转")){
            ...
            switch (weatherwhat(splits[0])){
                case 1:weather_img.setBackground(getDrawable(R.drawable.snow));break;
                case 2:weather_img.setBackground(getDrawable(R.drawable.rain));break;
                case 3:weather_img.setBackground(getDrawable(R.drawable.cloudy));break;
                default:weather_img.setBackground(getDrawable(R.drawable.sun));break;
            }
            switch (weatherwhat(splits[1])){
                case 1:weather_img2.setBackground(getDrawable(R.drawable.snow));break;
                case 2:weather_img2.setBackground(getDrawable(R.drawable.rain));break;
                case 3:weather_img2.setBackground(getDrawable(R.drawable.cloudy));break;
                default:weather_img2.setBackground(getDrawable(R.drawable.sun));break;
            }
        }else{
